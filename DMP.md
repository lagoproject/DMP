...
| Preliminary (L1) | Raw data from WCD | (_TBD. <sup>*</sup> (It is not supported by EOSC-Synergy_)) `L1_<site name>` |
| Quality (L2) | Cleaned data from WCD | (_TBD. It is not supported by EOSC-Synergy_) `L2_<site name>` |
| Quality (L3) | Cleaned data from WCD | (_TBD. It is not supported by EOSC-Synergy_) `L3_<site name>` |
...
| Analyzed (S1) | researchers | (_TBD. It is not supported by EOSC-Synergy_) `S1__<site>_<flux time>__<altitude>_ <CORSIKA version>_...` |
| Analyzed (S2) | researchers | (_TBD. It is not supported by EOSC-Synergy_) `S2__<site>_<flux time>__<altitude>_ <CORSIKA version>_...` |

<sup>*</sup>(_It is not supported by EOSC-Synergy_)
...
| Preliminary (L1) | None | None | (_TBD. It is not supported by EOSC-Synergy_) JSON-LD/DCAT-AP based [profile](./schema/) and [definitios](./defs/) |
| Quality for Astrophysics (L2) | None | None |  (_TBD. It is not supported by EOSC-Synergy_) JSON-LD/DCAT-AP based [profile](./schema/) and [definitios](./defs/) |  
| Quality for public (L3) | None | None |  (_TBD. It is not supported by EOSC-Synergy_) JSON-LD/DCAT-AP based [profile](./schema/) and [definitios](./defs/) |
...
| Analyzed (S1) | JSON for GEANT4/ROOT validator [(Freyermuth et. al, DOI:/10.1051/epjconf/201921405002)](https://doi.org/10.1051/epjconf/201921405002) | None | (_TBD . It is not supported by EOSC-Synergy_) JSON-LD/DCAT-AP based [profile](./schema/) and [definitios](./defs/) |
| Analyzed (S2) | None | None |  (_TBD . It is not supported by EOSC-Synergy_) JSON-LD/DCAT-AP based [profile](./schema/) and [definitios](./defs/) |
