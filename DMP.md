...
| Preliminary (L1) | Raw data from WCD | (_TBD[^1](It is not supported by EOSC-Synergy_)) `L1_<site name>` |
| Quality (L2) | Cleaned data from WCD | (_TBD^2. It is not supported by EOSC-Synergy_) `L2_<site name>` |
...
^2 (_It is not supported by EOSC-Synergy_)
